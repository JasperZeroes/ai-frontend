...
// import ProjectMailTable from "./ProjectMailTable";

type ProjectMailTableProps = {
  className: string;
  filterStatus: string;
};
...
const ProjectMailTable: React.FC<ProjectMailTableProps> = ({
  filterStatus,
  className,
}) => {
...
export const ApprovedEmails = () => {
  return <ProjectMailTable filterStatus="Approved" />;
};

export const PendingEmails = () => {
  return <ProjectMailTable filterStatus="Pending" />;
};
